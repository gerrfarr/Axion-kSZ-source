...
axion_masses = np.logspace(-33, -27, 61)#np.logspace(-27, -21, 61)#np.logspace(-27, -23, 41)#[5.0e-27, 5.0e-26, 1.0e-25, 1.0e-24]#[1.0e-27, 1.0e-26, 1.0e-25, 1.0e-24, 1.0e-23]#
...
if rank == 0:
    ...
    np.save(out_path+"ov_cells_lowMass", (ell_vals, outputs), allow_pickle=True)
